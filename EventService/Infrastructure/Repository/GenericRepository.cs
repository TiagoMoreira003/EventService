// --------------------------------------------------------------------------------------------------------------------
// <copyright file="GenericRepository.cs" company="KROWN">
...
namespace EventService.Infrastructure.Repository
{
		...
		where Entity : EntityBase
	{
		...
		/// The context
		/// </summary>
		protected readonly EventServiceDBContext Context;
		...
		public GenericRepository(EventServiceDBContext context)
		{
