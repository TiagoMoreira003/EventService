...
namespace EventService.Domain.AggregateModels.Event.Builder.EventBuilder
{
    ...
    public interface IEventBuilder
    {
        ...
        /// <returns></returns>
        IEventBuilder NewEvent(EventDate eventDate, MusicType musicType, Location location, string description, Guid tenantId, string name, Guid imageId, List<string> artists);
